  ...
  <div class="row">
    ...
    <div class="col-8">
        ...
        <div class="mb-3">
          ...
          <input type="password" class="form-control" id="new_password" name='new_password' require>
        </div>

        <div class="mb-3">
          <label for="password" class="form-label" >Re-Enter New Password</label>
          <input type="password" class="form-control" id="renew_password" name='renew_password' require>
        </div>
